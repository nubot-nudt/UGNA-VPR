...
def config_parser():
    ...
    parser.add_argument("--expname", type=str, default='nerfh', help='experiment name')
    ...
    parser.add_argument("--NeRFH", action='store_true', default=True, help='my implementation for NeRFH, to enable NeRF-Hist training, please make sure to add --encode_hist, otherwise it is similar to NeRFW')
