...
from script.models.nerf import run_network, NeRF
...
def create_nerf(args, scenes):
    ...
    ckpts = [os.path.join(basedir, expname, nerfh_name ,f) for f in sorted(os.listdir(os.path.join(basedir, expname,nerfh_name))) if 'tar' in f]
